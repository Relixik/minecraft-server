...
import (
	...
	impl_level "github.com/Relixik/minecraft-server/impl/game/level"

	impl_event "github.com/Relixik/minecraft-server/impl/game/event"

	client_packet "github.com/Relixik/minecraft-server/impl/prot/client"
	server_packet "github.com/Relixik/minecraft-server/impl/prot/server"
)
