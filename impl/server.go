...
import (
	...
	"github.com/Relixik/minecraft-server/impl/conf"
	"github.com/Relixik/minecraft-server/impl/data/plugin"

	"github.com/Relixik/minecraft-server/impl/conn"
	"github.com/Relixik/minecraft-server/impl/cons"
	"github.com/Relixik/minecraft-server/impl/data/system"
	"github.com/Relixik/minecraft-server/impl/data/values"
	"github.com/Relixik/minecraft-server/impl/prot"

	apis_base "github.com/Relixik/minecraft-server/apis/base"
	impl_base "github.com/Relixik/minecraft-server/impl/base"

	apis_event "github.com/Relixik/minecraft-server/apis/game/event"
	impl_event "github.com/Relixik/minecraft-server/impl/game/event"
)
